...
| `mermaid_theme` | `"dark"` | Color theme for image-mode diagrams: `"dark"`, `"light"`, `"classic"`, `"forest"`, `"neutral"`. The background is always transparent (blends with the terminal). |
