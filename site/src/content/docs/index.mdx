...
build, pass the full test suite in CI, and ship prebuilt binaries (Linux is beta —
runtime not yet verified on a real Linux desktop). For image previews you need a
terminal that speaks the kitty graphics protocol, such as [Ghostty](https://ghostty.org). Then:
