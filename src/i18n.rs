...
fn en(msg: Msg) -> &'static str {
    ...
    match msg {
        ...
        TreeBookmarkHint => "bookmark cursor item: m=set, '=jump (file→preview/dir→cd), ''=list (a-z local / A-Z global)",
        ...
        FocusMdLink => "focus md link",
        GitToolFailed => "git tool failed: ",
        GlobalApp => "global",
        GotoMarkHint => "goto ▸ a-z / A-Z mark,  '' = list   Esc",
        HScroll => "horizontal scroll",
        GitHScrollEnds => "hscroll / line ends",
        StCloseHint => "i / Esc / q : close",
        InfoClose => "i / Esc / q close",
        AnchorsUnsupported => "in-page anchors are not supported",
        ...
        DiffScrollDiscardHint => "j/k:scroll  h/l:hscroll  s:unified/split/auto  x:discard  q/Esc:back",
        ...
        OpenLinkHint => "open link (URL=browser / local=konoma)",
        Opened => "opened: ",
        ...
        Zoom => "zoom",
        BmActions => "↵ open   e edit   d delete   Esc close",
        Empty => "",
        ...
        PreviewVisualHint => "h / j / k / l: extend    y: copy    v / Esc: cancel",
        PreviewVisualLineHint => "j / k / g / G: extend    y: copy lines    V / Esc: cancel",
...
fn jp(msg: Msg) -> &'static str {
    ...
    match msg {
        ...
        BackToTree => "ツリーへ戻る",
        TreeBookmarkHint => "ブックマーク(カーソル位置): m=登録, '=ジャンプ(ファイル→preview/dir→移動), ''=一覧 (a-z ローカル/A-Z グローバル)",
        ...
        DiffScrollDiscardHint => "j/k:スクロール  h/l:横移動  s:縦/横/Auto  x:破棄  q/Esc:戻る",
        ...
        OpenFailed => "起動失敗: ",
        OpenLinkHint => "リンクを開く (URL=ブラウザ / ローカル=konoma)",
        Opened => "開きました: ",
        ...
        Zoom => "ズーム",
        BmActions => "↵ 開く   e 編集   d 削除   Esc 閉じる",
        Empty => "",
        ...
        PreviewVisualHint => "h / j / k / l: 範囲拡張    y: コピー    v / Esc: 取消",
        PreviewVisualLineHint => "j / k / g / G: 範囲拡張    y: 行コピー    V / Esc: 取消",
