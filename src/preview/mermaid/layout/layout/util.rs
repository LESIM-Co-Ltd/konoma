...
pub(crate) fn add_dummy_node(
    ...
    while g.has_node(&v) {
        v = crate::preview::mermaid::layout::util::unique_id(prefix);
    }
...
/// [`crate::preview::mermaid::layout::layout::intersect`] — downstream callers that need to clip
...
/// Test-only `&NodeLabel` adaptor over [`crate::preview::mermaid::layout::layout::intersect::intersect_rect`].
